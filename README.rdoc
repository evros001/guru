...
ACT I [Hook:, Setup:, Enter Antagonist:, Supporting Characters:, Plot Goal (Want):, Gauntlet:, First Test:, Inciting Incident:]
...
ACT II [Exile:, Plot Goals Restated:, Theme Goals Restated:, McGuffin:, Investigation:, Meet Mentor:, Acquire New Tools:, Joke:, Foreshadow:, Unique Genre Color:, First Theme Success:, Triumph First Plot Success:, Betrayal:, Big Bad Twist:, Torture/Escape:, Defeat:, Reassess Plot Goal:, Restate Theme Goal:, Mentor Disabled:, Second Joke:, Unique Genre Element:, Surrender:, McGuffin:, New Solution:]
...
ACT III [Final Confrontation, Death, Resurrection, Sacrifice, Revelation, Climax, Resolution]
